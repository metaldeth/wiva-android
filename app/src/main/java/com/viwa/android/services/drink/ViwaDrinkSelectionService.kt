...
import com.viwa.android.domain.model.customer.toTofByte
 ...
 *
 * **Без калибровки воды готовка не запускается** — [flowRateMlPerSec] обязателен и > 0 (проверка в [com.viwa.android.services.preparing.PreparingManager]).
 */
@Singleton
class ViwaDrinkSelectionService
@Inject
constructor(
 ...
 */
    ...
    companion object {
        private const val TAG = "ViwaDrinkSelection"
    }
}
