...
private enum class ViwaAlphanumericMode {
    Letters,
    Numbers,
    Symbols,
}
 ...
 */
@Composable
fun ViwaAlphanumericKeyboard(
    modifier: Modifier = Modifier,
    onInput: (String) -> Unit,
    onBackspace: () -> Unit,
    onEnter: () -> Unit = {},
) {
    var mode by remember { mutableStateOf(ViwaAlphanumericMode.Letters) }
        ...
        when (mode) {
            ViwaAlphanumericMode.Letters -> {
                ...
                Row(
                    Modifier
                        .fillMaxWidth()
                        .padding(start = ViwaKeyboardSpec.LetterRowStagger),
                ...
                KeyboardRow(gapH) {
                    ViwaKeyboardKey(
                        ...
                        onClick = { mode = ViwaAlphanumericMode.Numbers },
                    )
                    ViwaKeyboardKey(
                        label = ",",
                        modifier = Modifier.weight(1f),
            ...
            ViwaAlphanumericMode.Numbers -> {
                ...
                KeyboardRow(gapH) {
                    ViwaKeyboardKey(
                        ...
                        emphasizedBackground = true,
                        onClick = { mode = ViwaAlphanumericMode.Symbols },
                    )
                    ViwaKeyboardKey(
                        label = ".",
                        modifier = Modifier.weight(1f),
                ...
                Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(gapH)) {
                    ViwaKeyboardKey(
                        ...
                        modifier = Modifier.weight(1f),
                        emphasizedBackground = true,
                        onClick = { mode = ViwaAlphanumericMode.Letters },
                    )
                }
            }

            ViwaAlphanumericMode.Symbols -> {
                KeyboardRow(gapH) {
