...
constructor(
    ...
    private val hardware: com.viwa.android.hardware.controller.ControllerHardwareManager,
 ...
 /**
 * После [com.viwa.android.services.preparing.CustomerPreparingPhase.DrinkReady]: зелёный 10 с, затем цвет из настроек.
 */
