...
import com.viwa.android.hardware.serial.SerialConnection
 ...
 * (ключ [com.viwa.android.data.local.db.JsonStoreKeys.PORT_ASSIGNMENTS]).
 */
@Singleton
...
constructor(
    ...
    private val trafficLogger: ViwaScannerTrafficLogger,
