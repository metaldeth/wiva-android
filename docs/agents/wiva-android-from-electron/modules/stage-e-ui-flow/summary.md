...
- `services/drink/ChooseDrinkBodyBuilder.kt`, `ViwaDrinkSelectionService.kt`
...
- `ServiceViewModel.kt`, `ViwaServiceMenuTabContent.kt` — free mode UI
