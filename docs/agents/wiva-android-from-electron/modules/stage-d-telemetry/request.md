# Запрос сессии: stage-d-telemetry

**Режим:** complex (оркестратор + субагенты).

**ПАРАМЕТРЫ ЭТАПА:** `5 | stage-d-telemetry | D1–D4`

**ТЗ:** `wiva-android/docs/TZ_WIVA_ANDROID_FROM_ELECTRON.md` — модуль D (телеметрия).
