# Запрос сессии: stage-f-office (этап 7)

**Режим:** complex.

**ПАРАМЕТРЫ ЭТАПА (интерпретация):** пользователь указал только сегмент «7»; по `CHECKLIST_WIVA_ANDROID_STAGES.md` это **этап 7** → `moduleId=stage-f-office`, задачи **F1–F2**.

**ТЗ:** `wiva-android/docs/TZ_WIVA_ANDROID_FROM_ELECTRON.md` — выполнить только ID **F1, F2** (модуль F — офис / железо).
